...
(function (app) {
  ...
  app.registerModule('helps');
})(ApplicationConfiguration);

(function (app) {
  'use strict';

  app.registerModule('todos');
})(ApplicationConfiguration);
...
(function () {
  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('customers.create', {
        url: '/create',
        templateUrl: 'modules/customers/client/views/customers.html',
...
(function () {
  ...
  TodosController.$inject = ['$scope', '$state', 'Authentication', 'todoResolve'];

  function TodosController ($scope, $state, Authentication, todo) {
    var vm = this;
